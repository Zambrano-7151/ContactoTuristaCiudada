...
public class IngenioCriadero : MonoBehaviour
{
    ...
    private IEnumerator OnReponse(UnityWebRequest req)
    {
        ...
        else
        {
            ...
            StartCoroutine(LoadURL("https://cde.peru.com//ima/0/0/9/6/5/965822/turismo.jpg", (resp) => {
                Foto.sprite = resp;
            }));
            StartCoroutine(LoadURL("https://turismoi.pe/uploads/photo/version2/photo_file/50235/optimized_4507-1.jpg", (resp) => {
                Foto1.sprite = resp;
            }));
    ...
    {
        var dataJson = "{\"ID_Lugar_Turistico\": 34}";
