...
public class LagunaPaca : MonoBehaviour
{
    private const string WEB_URL = "http://smartcityhyo.tk/api/LugarTuristico/Consultar_Lugar_Turistico_ID.php?ID_Lugar_Turistico=9";
    [Header("CONTROLS")]
    ...
    private IEnumerator OnReponse(UnityWebRequest req)
    {
       ...
       // provincia.text = req.downloadHandler.text;
        ...
        else
        {
            ...
            StartCoroutine(LoadURL("https://portal.andina.pe/EDPfotografia/Thumbnail/2015/08/08/000307867W.jpg", (resp) => {
                Foto.sprite = resp;
            }));
            StartCoroutine(LoadURL("https://1.bp.blogspot.com/-azIFcDc6ul4/UgcGkAPq-xI/AAAAAAAAAEc/lnzP9uA3M8k/w1200-h630-p-k-no-nu/laguna-paca-jauja.JPG", (resp) => {
                Foto1.sprite = resp;
            }));
    ...
    {
        var dataJson = "{\"ID_Lugar_Turistico\": 22}";
