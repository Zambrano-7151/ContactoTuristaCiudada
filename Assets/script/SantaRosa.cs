...
public class SantaRosa : MonoBehaviour
{
    ...
    private IEnumerator OnReponse(UnityWebRequest req)
    {
        ...
        else
        {
            ...
            StartCoroutine(LoadURL("https://media-cdn.tripadvisor.com/media/photo-s/09/7c/7e/07/convento-de-santa-rosa.jpg", (resp) => {
                Foto.sprite = resp;
            }));
            StartCoroutine(LoadURL("https://pbs.twimg.com/media/CEXQs_yXIAAsyUl.png", (resp) => {
                Foto1.sprite = resp;
            }));
    ...
    {
        var dataJson = "{\"ID_Lugar_Turistico\": 23}";
